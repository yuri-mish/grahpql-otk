...
!function (e, t) {
  ...
  return function (e) {
    ...
    function r(e) {
      ...
      }for (var t = {}, n = 0, o = arguments.length; n < o; n++) b(arguments[n], e);return t;
    }function C(e, t, n) {
      ...
      return new Promise(function (t, n) {
        var p = e.data,
          ...
          var h = e.auth.username || "",
              m = e.auth.password ? unescape(encodeURIComponent(e.auth.password)) : "";d.Authorization = "Basic " + btoa(h + ":" + m);
        }var y = a(e.baseURL, e.url);if (l.open(e.method.toUpperCase(), i(y, e.params, e.paramsSerializer), !0), l.timeout = e.timeout, l.onreadystatechange = function () {
          if (l && 4 === l.readyState && (0 !== l.status || l.responseURL && 0 === l.responseURL.indexOf("file:"))) {
            var r = "getAllResponseHeaders" in l ? u(l.getAllResponseHeaders()) : null,
                ...
                i = { data: s, status: l.status, statusText: l.statusText, headers: r, config: e, request: l };o(t, n, i), l = null;
          }
        }, l.onabort = function () {
          ...
          var g = (e.withCredentials || c(y)) && e.xsrfCookieName ? s.read(e.xsrfCookieName) : void 0;g && (d[e.xsrfHeaderName] = g);
    ...
    "use strict";
    var r = n(15);e.exports = function (e, t, n, o, s) {
    ...
    var r = n(2);e.exports = function (e, t) {
      function n(e, t) {
        ...
        r.isUndefined(t[o]) ? r.isUndefined(e[o]) || (s[o] = n(void 0, e[o])) : s[o] = n(e[o], t[o]);
          ...
          c = ["validateStatus"];r.forEach(i, function (e) {
